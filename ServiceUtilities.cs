...
namespace MagicUWP
{
    class ServiceUtilities
    {
        ...
        public string accessKeyId = "AKIAITMECEVZRRUTLDWQ";
        public string secretAccessKey = "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";

        public ServiceUtilities()
        { }

        public ServiceUtilities(string secretKey, string accesskey)
        {
        ...
        public async Task<string> createS3()
        {
            region = RegionEndpoint.USWest2;
                    ...
                    if (found == true)
                    {
                        ...
                        if (true)
                        {
                            ...
                            if (("" + x.HttpStatusCode).Equals("OK"))
                            {
                                ...
                                **/
                                string controller_text_content = Constants.controller_text_content.Replace("<region_name>", region.SystemName).Replace("<bucket_name>", BUCKET_NAME).Replace("<bucket_guid>", genGuid)
                                        .Replace("<secret_access_key>", "foo")
                                        .Replace("<access_key_id>", "bar");
